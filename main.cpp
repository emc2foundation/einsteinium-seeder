...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Einsteinium-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseeder01.emc2.foundation", ""};
static const string testnet_seeds[] = {"dnsseeder01.emc2.foundation", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 41878), true);
  }
  do {
